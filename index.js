...
printIngredients = (value, index) => {
  ...
  render() {   
    ...
    <div id="class1">
          <h1 id="heading">Recipe Finder</h1>
    ...
    <div id="container1">
      ...
      <div id="class2">
         ...
         <div><i id="main11" className="far fa-heart" onClick={this.toggleLike}></i></div>
      </div>
      ...
      <div id="appearance">
        ...
        <div id="right">
         ...
         <i>Ingredients</i>
         <div id="ingred">{this.state.ingredients[0].map(this.printIngredients)}</div>
